...
export const NEXT_PUBLIC_FUNDING_ARTICLE_URL =
  process.env.NEXT_PUBLIC_FUNDING_ARTICLE_URL ||
  "";
export const NEXT_PUBLIC_FIREBASE_PROJECT_ID =
  process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID;
export const DEMO_USER = process.env.NEXT_PUBLIC_USER_NAME;
...
export const PUBLIC_API_URL = process.env.NEXT_PUBLIC_REACT_API_URL;
export const STRIPE_PUBLISH_KEY =
  process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY;
export const testvariable = "djdd";
