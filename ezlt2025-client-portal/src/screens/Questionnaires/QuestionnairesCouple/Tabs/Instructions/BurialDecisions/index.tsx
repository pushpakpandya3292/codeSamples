...
import {
  ArrangementModalSecondary,
  AshesModalSecondary,
  FuneralModalSecondary,
  LaidModalSecondary,
} from "./SecondaryModals";
...
const BurialDecisions = () => {
  ...
  const [openAshesSecondary, setOpenAshesSecondary] = useState(false);
  const [openLaidSecondary, setOpenLaidSecondary] = useState(false);
  const [openFuneralSecondary, setOpenFuneralSecondary] = useState(false);
  const [openArrangementSecondary, setOpenArrangementSecondary] =
    useState(false);
  ...
  // Secondary modal open and close Functions
  const handleAshesOpenSecondary = () => {
    setOpenAshesSecondary(true);
  };
  const handleAshesCloseSecondary = () => {
    setOpenAshesSecondary(false);
  };
  const handleFuneralOpenSecondary = () => {
    setOpenFuneralSecondary(true);
  };
  const handleFuneralCloseSecondary = () => {
    setOpenFuneralSecondary(false);
  };
  const handleArrangementOpenSecondary = () => {
    setOpenArrangementSecondary(true);
  };
  const handleArrangementCloseSecondary = () => {
    setOpenArrangementSecondary(false);
  };

  const handleLaidOpenSecondary = () => {
    setOpenLaidSecondary(true);
  };
  const handleLaidCloseSecondary = () => {
    setOpenLaidSecondary(false);
  };
  ...
  return (
    <Box>
      ...
      <Grid container spacing={3}>
        ...
        <Grid xs={12} md={6} item>
          <BoxWrapper sx={{ p: 2, mb: 2 }}>
            ...
            <Controller
              name={"burial_decisions_for_secondary"}
              control={control}
              render={({ field, fieldState: { error } }) => (
                <RadioGroup sx={{ mt: 1 }} {...field}>
                  <CustomRadioButton
          ...
          watch("burial_decisions_for_secondary") === BurialEnum[1] ? (
            <Box>
              <Controller
                name="body_buried_cremated_secondary"
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <>
                    {watch("burial_decisions_for_secondary") ===
                      BurialEnum[2] && (
                      <BoxWrapper sx={{ mb: 2 }}>
                        <Typography>
                          {watch("secondary_trustee_first_name")}{" "}
                        ...
                        <Box
                          onClick={handleAshesOpenSecondary}
                          sx={{
                            background: (theme) =>
                              theme.additionalColors?.formInputBg,
                            p: 1,
                        ...
                        >
                          ...
                          >
                            My wishes are that my ashes be: <br />
                            <pre>{watch("body_buried_cremated_secondary")}</pre>
                          </Typography>
                    ...
                    {watch("burial_decisions_for_secondary") ===
                      ...
                      <BoxWrapper sx={{ mb: 2 }}>
                        ...
                        <Box
                          onClick={handleLaidOpenSecondary}
                          sx={{
                            background: (theme) =>
                              theme.additionalColors?.formInputBg,
                            p: 1,
              ...
              <BoxWrapper sx={{ mb: 2 }}>
                ...
                <Controller
                  name="funeral_service_secondary"
                  control={control}
                  render={({ field, fieldState: { error } }) => (
                    <>
                      <Box
                        {...field}
                        onClick={handleFuneralOpenSecondary}
                        sx={{
                          background: (theme) =>
                            theme.additionalColors?.formInputBg,
                          p: 1,
                      ...
                      >
                        ...
                        >
                          My funeral/memorial services are the following: <br />
                          <pre>{watch("funeral_service_secondary")}</pre>
                        </Typography>
                        {watch("funeral_service_secondary") && (
                          <Edit
                            sx={{
                              fontSize: "16px",
                              position: "absolute",
              ...
              <BoxWrapper sx={{ mb: 2 }}>
                <Typography>
                  {watch("secondary_trustee_first_name")}{" "}
                  {watch("secondary_trustee_last_name")}, have you already made
                  any arrangements to let your family know?
                </Typography>
                <Controller
                  name="post_death_arrangement_secondary"
                  control={control}
                  render={({ field, fieldState: { error } }) => (
                    <>
                      <Box
                        {...field}
                        onClick={handleArrangementOpenSecondary}
                        sx={{
                          background: (theme) =>
                            theme.additionalColors?.formInputBg,
                          p: 1,
                      ...
                      >
                        ...
                        >
                          The following are my post-death arrangements: <br />
                          <pre>{watch("post_death_arrangement_secondary")}</pre>
                        </Typography>
      ...
      {/* Secondary Modal */}
      <AshesModalSecondary
        open={openAshesSecondary}
        handleClose={handleAshesCloseSecondary}
      />
      <FuneralModalSecondary
        open={openFuneralSecondary}
        handleClose={handleFuneralCloseSecondary}
      />
      <ArrangementModalSecondary
        open={openArrangementSecondary}
        handleClose={handleArrangementCloseSecondary}
      />
      <LaidModalSecondary
        open={openLaidSecondary}
        handleClose={handleLaidCloseSecondary}
      />
    </Box>
  );
};
