...
const AddTrustee = ({
  ...
  const emptyFieldValues = () => {
    setValue("temp_primary_financial_agent_modal_open", false);
    setValue("temp_primary_financial_agent_full_name", "");
    setValue("temp_primary_financial_agent_email", "");
    setValue("temp_primary_financial_agent_address", null);
    setValue("temp_primary_financial_agent_phone_number", "");
    setValue("temp_primary_trustee_financial_agent_relation", "");
    setValue("temp_secondary_trustee_financial_agent_relation_primary", "");
    setValue("temp_secondary_primary_financial_agent_relation_primary", "");

    setValue("temp_backup_financial_agent_modal_open", false);
    setValue("temp_backup_financial_agent_full_name", "");
    setValue("temp_backup_financial_agent_email", "");
    setValue("temp_backup_financial_agent_address", null);
    setValue("temp_backup_financial_agent_phone_number", "");
    setValue("temp_backup_trustee_financial_agent_relation", "");
    setValue("temp_secondary_trustee_financial_agent_relation_backup", "");
    setValue("temp_secondary_primary_financial_agent_relation_backup", "");
  };

  const handleAddTrusteeOpen = () => {
    if (isPrimary) {
      setValue("temp_primary_financial_agent_modal_open", true);
    } else {
      setValue("temp_backup_financial_agent_modal_open", true);
    }
  ...
  const handleAddFinancialAgent = async () => {
      ...
      if (forSecondaryTrustee) {
        if (isPrimary) {
          setValue(
            ...
            watch("temp_primary_financial_agent_full_name"),
          );
          setValue(
            "primary_financial_agent_email_secondary_trustee",
            watch("temp_primary_financial_agent_email"),
          );
          setValue(
            "primary_financial_agent_address_secondary_trustee",
            watch("temp_primary_financial_agent_address"),
          );
          setValue(
            "primary_financial_agent_phone_number_secondary_trustee",
            watch("temp_primary_financial_agent_phone_number"),
          );
          setValue(
            "primary_trustee_financial_agent_relation_secondary_trustee",
            watch("temp_primary_trustee_financial_agent_relation"),
          );
          setValue(
            "secondary_trustee_financial_agent_relation_primary_secondary_trustee",
            watch("temp_secondary_trustee_financial_agent_relation_primary"),
          );
          setValue(
            "secondary_primary_financial_agent_relation_primary_secondary_trustee",
            watch("temp_secondary_primary_financial_agent_relation_primary"),
          );
          const personDetalis = {
            id: uuidv4(),
            full_Name: watch("temp_primary_financial_agent_full_name"),
            email: watch("temp_primary_financial_agent_email"),
            address: watch("temp_primary_financial_agent_address"),
            mobile: watch("temp_primary_financial_agent_phone_number"),
            primary_trustee_child_relation: watch(
              "temp_primary_trustee_financial_agent_relation",
            ),
            secondary_trustee_child_relation: watch(
              "temp_secondary_trustee_financial_agent_relation_primary",
            ),
            secondary_primary_child_relation: watch(
              "temp_secondary_primary_financial_agent_relation_primary",
            ),
          };
          ...
          setValue(
            ...
            watch("temp_backup_financial_agent_full_name"),
          );
          setValue(
            "backup_financial_agent_email_secondary_trustee",
            watch("temp_backup_financial_agent_email"),
          );
          setValue(
            "backup_financial_agent_address_secondary_trustee",
            watch("temp_backup_financial_agent_address"),
          );
          setValue(
            "backup_financial_agent_phone_number_secondary_trustee",
            watch("temp_backup_financial_agent_phone_number"),
          );
          setValue(
            "backup_trustee_financial_agent_relation_secondary_trustee",
            watch("temp_backup_trustee_financial_agent_relation"),
          );
          setValue(
            "secondary_trustee_financial_agent_relation_backup_secondary_trustee",
            watch("temp_secondary_trustee_financial_agent_relation_backup"),
          );
          setValue(
            "secondary_primary_financial_agent_relation_backup_secondary_trustee",
            watch("temp_secondary_primary_financial_agent_relation_backup"),
          );
          const personDetalis = {
            id: uuidv4(),
            full_Name: watch("temp_backup_financial_agent_full_name"),
            email: watch("temp_backup_financial_agent_email"),
            address: watch("temp_backup_financial_agent_address"),
            mobile: watch("temp_backup_financial_agent_phone_number"),
            primary_trustee_child_relation: watch(
              "temp_backup_trustee_financial_agent_relation",
            ),
            secondary_trustee_child_relation: watch(
              "temp_secondary_trustee_financial_agent_relation_backup",
            ),
            secondary_primary_child_relation: watch(
              "temp_secondary_primary_financial_agent_relation_backup",
            ),
          };
          Agents_details.append(personDetalis);
        }
        ...
        if (isPrimary) {
          ...
          setValue(
            "primary_financial_agent_email",
            watch("temp_primary_financial_agent_email"),
          );
          setValue(
            "primary_financial_agent_address",
            watch("temp_primary_financial_agent_address"),
          );
          setValue(
          ...
          setValue(
            "backup_financial_agent_email",
            watch("temp_backup_financial_agent_email"),
          );
          setValue(
            "backup_financial_agent_address",
            watch("temp_backup_financial_agent_address"),
          );
          setValue(
  ...
  const handleCancelFinancialAgent = () => {
    if (isPrimary) {
      setValue("temp_primary_financial_agent_modal_open", false);
    } else {
      setValue("temp_backup_financial_agent_modal_open", false);
  ...
  const changeAgent = (index: number) => {
    ...
    if (!forSecondaryTrustee) {
      if (!isPrimary) {
        setValue("backup_financial_agent_id", Agent?.id);
        setValue("backup_financial_agent_full_name", Agent.full_Name);
        setValue("backup_financial_agent_email", Agent.email);
        setValue("backup_financial_agent_phone_number", Agent.mobile);
        setValue(
          "backup_trustee_financial_agent_relation",
        ...
        setValue("backup_financial_agent_address", Agent.address);
        setSelectedAgent(index);
        // if (Agent.full_Name !== watch("primary_financial_agent_full_name")) {
        // } else {
        //   toast.error("Please select different person");
        // }
      } else {
        setValue("primary_financial_agent_id", Agent?.id);
        setValue("primary_financial_agent_full_name", Agent.full_Name);
        setValue("primary_financial_agent_email", Agent.email);
        setValue("primary_financial_agent_phone_number", Agent.mobile);
        setValue(
          "primary_trustee_financial_agent_relation",
          Agent.primary_trustee_child_relation,
        );
        ...
        setValue("primary_financial_agent_address", Agent.address);
        setSelectedAgent(index);
        // if (Agent.full_Name !== watch("backup_financial_agent_full_name")) {
        // } else {
        //   toast.error("Please select different person");
        // }
      }
      ...
      if (!isPrimary) {
        ...
        setValue("backup_financial_agent_email_secondary_trustee", Agent.email);
        setValue(
          "backup_financial_agent_phone_number_secondary_trustee",
          Agent.mobile,
        );
        ...
        // if (
        //   Agent.full_Name !==
        //   watch("primary_financial_agent_full_name_secondary_trustee")
        // ) {
        // } else {
        //   toast.error("Please select different person");
        // }
        ...
        // if (
        //   Agent.full_Name !==
        //   watch("backup_financial_agent_full_name_secondary_trustee")
        // ) {
        // } else {
        //   toast.error("Please select different person");
        // }
  ...
  const handleSelectedChildIndex = () => {
    ...
    if (forSecondaryTrustee) {
      ...
      if (isPrimary) {
        watch("Agents_details").forEach((child: any, index: number) => {
          if (
            child.full_Name === watch("primary_financial_agent_full_name") &&
            child.secondary_primary_child_relation ===
            watch("secondary_primary_financial_agent_relation_primary")
          ) {
            setSelectedAgent(index);
          }
        });
        ...
        watch("Agents_details").forEach((child: any, index: number) => {
          if (
            child.full_Name === watch("backup_financial_agent_full_name") &&
            child.secondary_primary_child_relation ===
            watch("secondary_primary_financial_agent_relation_backup")
          ) {
            setSelectedAgent(index);
          }
        });
      ...
      >
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={4}>
            <Controller
              name={
                isPrimary
                  ? "temp_primary_financial_agent_full_name"
                  : "temp_backup_financial_agent_full_name"
              }
              control={control}
          ...
          <Grid item xs={12} md={4}>
            <Controller
              name={
                isPrimary
                  ? "temp_primary_financial_agent_email"
                  : "temp_backup_financial_agent_email"
              }
              control={control}
              render={({ field, fieldState: { error } }) => (
                <CustomTextField
          ...
          <Grid item xs={12} md={4}>
            <Controller
              name={
                isPrimary
                  ? "temp_primary_financial_agent_phone_number"
                  : "temp_backup_financial_agent_phone_number"
              }
              control={control}
              render={({ field, fieldState: { error } }) => (
                <PhoneNumberField
          ...
          <Grid item xs={12} md={12}>
            <Controller
              name={
                isPrimary
                  ? "temp_primary_financial_agent_address"
                  : "temp_backup_financial_agent_address"
              }
              control={control}
              render={({ field, fieldState: { error } }) => (
                <GoogleMaps>
          ...
          <Grid item xs={12} md={12} sx={{ marginTop: "-18px" }}>
            <Controller
              name={
                isPrimary
                  ? "temp_primary_financial_agent_age"
                  : "temp_backup_financial_agent_age"
              }
              control={control}
              render={({ field, fieldState: { error } }) => (
                <>
                  <CustomCheckBox
                    ...
                    setChecked={(value) => {
                      isPrimary
                        ? setValue("temp_primary_financial_agent_age", value)
                        : setValue("temp_backup_financial_agent_age", value);
                    }}
                    checked={
                      isPrimary
                        ? watch("temp_primary_financial_agent_age")
                        : watch("temp_backup_financial_agent_age")
                    }
                    type="SQUARE"
                  >
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", gap: "15px" }}>
          ...
          <Button
            ...
            onClick={handleCancelFinancialAgent}
          >
            Cancel
          </Button>
          <Button
            ...
            variant="contained"
            onClick={handleAddFinancialAgent}
          >
            Add Financial agent
          </Button>
        </Box>
