            ...
            <BoxWrapper sx={{ p: 2 }}>
              ...
              <Box sx={{ pb: 3 }}>
                ...
                >
                  ...
                  ${
                    TrusteeChildBothRealtionEnum[
                      secondary_primary_guardian_relation_primary as keyof typeof TrusteeChildBothRealtionEnum
                    ]
                      ? TrusteeChildBothRealtionEnum[
                          secondary_primary_guardian_relation_primary as keyof typeof TrusteeChildBothRealtionEnum
                        ]
                      : TrusteeBothRealtionWithPersonEnum[
                          secondary_primary_guardian_relation_primary as keyof typeof TrusteeBothRealtionWithPersonEnum
                        ]
                  }`
              ...
              <Box sx={{ pb: 3 }}>
                ...
                >
                  ...
                  ${
                    TrusteeChildBothRealtionEnum[
                      secondary_primary_guardian_relation_backup as keyof typeof TrusteeChildBothRealtionEnum
                    ]
                      ? TrusteeChildBothRealtionEnum[
                          secondary_primary_guardian_relation_backup as keyof typeof TrusteeChildBothRealtionEnum
                        ]
                      : TrusteeBothRealtionWithPersonEnum[
                          secondary_primary_guardian_relation_backup as keyof typeof TrusteeBothRealtionWithPersonEnum
                        ]
                  }`
