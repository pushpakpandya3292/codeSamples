...
const AddChild = ({
  ...
  return (
    <CustomModal open={open} width={{ xs: "100%", sm: "auto" }} height="auto" handleClose={handleClose}>
      ...
      >
        <Typography variant="h2">Add Secondary Trustee Child</Typography>
      </Box>
      <Box>
        <Grid container spacing={2}>
          <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_full_name"}
                control={control}
          ...
          <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_date_of_birth"}
                control={control}
                render={({ field, fieldState: { error } }) => (
          ...
          <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_age"}
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <CustomTextField
                    {...field}
          ...
          <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_email"}
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <CustomTextField
                    {...field}
          ...
          <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name="secondary_trustee_childern_mobile_number"
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <PhoneNumberField
                    {...field}
          ...
          {/* <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_primary_relation"}
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <CustomTextField
                    {...field}
          ...
          <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_secondary_relation"}
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <CustomTextField
                    {...field}
          ...
          {/* <Grid item xs={12} md={4}>
            <Item>
              <Controller
                name={"secondary_trustee_childern_both_trustee_relation"}
                control={control}
                render={({ field, fieldState: { error } }) => (
                  <CustomTextField
                    {...field}
