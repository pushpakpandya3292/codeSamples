...
const StripeCheckout: React.FC = () => {
  ...
  useEffect(() => {
    if (watch("defaultPromoCode") && couple_price) {
  ...
  return (
    <>
      <Box mt={1} mb={2}>
        {/* <Typography fontSize={16}>Final Checkout Price</Typography>
