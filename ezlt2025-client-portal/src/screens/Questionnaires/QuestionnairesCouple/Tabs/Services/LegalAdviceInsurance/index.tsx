      ...
      <Grid container spacing={3}>
        ...
        all legal topics.`}
          ...
          >
            ...
            {/* <Typography variant="h5">
              This benefit is not to be used for matters when you wish to take
              legal action against another party. It is designed to protect you
              and help you better understand your legal rights.
            </Typography>
      ...
      >
        <Box sx={{ position: "relative" }}>
          <Image
            src={Logo}
            alt=""
            style={{ width: "174px", height: "26px", alignSelf: "center" }}
          />
          <Typography variant="h2" sx={{ mt: 2, fontSize: "18px" }}>
            Steps to enroll
          </Typography>
          <List>
            {Steps.map((question, i) => {
              return (
                <ListItem sx={{ gap: 3, py: 0.5 }} key={i}>
                  <CircleRoundedIcon sx={{ fontSize: "6px", color: "black" }} />
                  <ListItemText
                    sx={{ span: { color: "black", fontWeight: 500 } }}
        ...
        >
          <CustomButton type="CANCEL" onClick={handleCancelModal}>
            Cancel
          </CustomButton>
          <CustomButton type="ADD" onClick={handleConfirmModal}>
            Proceed
          </CustomButton>
        </Box>
      </CustomModal> */}
