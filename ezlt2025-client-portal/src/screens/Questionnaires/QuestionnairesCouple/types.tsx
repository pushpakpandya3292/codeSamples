...
export interface ILIVING_TRUST_QUESTIONS {
  ...
  secondary_trustee_is_editing: boolean;
  ...
  living_childern_secondary_relation: string;
  living_childern_both_trustee_relation: string;
  ...
  primary_trustee_childern: boolean | undefined;
  primary_trustee_childern_modal_open: boolean;
  primary_trustee_childern_full_name: string;
  primary_trustee_childern_date_of_birth: string;
  primary_trustee_childern_age: number;
  primary_trustee_childern_email: string;
  primary_trustee_childern_mobile_number: string;
  primary_trustee_childern_primary_relation: string;
  // primary_trustee_childern_secondary_relation: string;
  // primary_trustee_childern_both_trustee_relation: string;
  ...
  secondary_trustee_childern: boolean | undefined;
  secondary_trustee_childern_modal_open: boolean;
  secondary_trustee_childern_full_name: string;
  secondary_trustee_childern_date_of_birth: string;
  secondary_trustee_childern_age: number;
  secondary_trustee_childern_email: string;
  secondary_trustee_childern_mobile_number: string;
  // secondary_trustee_childern_primary_relation: string;
  secondary_trustee_childern_secondary_relation: string;
  // secondary_trustee_childern_both_trustee_relation: string;
  ...
  temp_secondary_trustee_successor_relation_primary: string;
  temp_secondary_primary_successor_relation_primary: string;
  ...
  temp_secondary_trustee_successor_relation_backup: string;
  temp_secondary_primary_successor_relation_backup: string;
  ...
  secondary_trustee_successor_relation_primary: string;
  secondary_primary_successor_relation_primary: string;
  ...
  secondary_trustee_successor_relation_backup: string;
  secondary_primary_successor_relation_backup: string;
  ...
  temp_secondary_trustee_health_agent_relation_primary: string;
  temp_secondary_primary_health_agent_relation_primary: string;
  ...
  temp_secondary_trustee_health_agent_relation_backup: string;
  temp_secondary_primary_health_agent_relation_backup: string;
  ...
  secondary_trustee_health_agent_relation_primary: string;
  secondary_primary_health_agent_relation_primary: string;
  ...
  secondary_trustee_health_agent_relation_backup: string;
  secondary_primary_health_agent_relation_backup: string;
  backup_health_agent_address: string;

  primary_health_agent_full_name_secondary_trustee: string;
  primary_health_agent_email_secondary_trustee: string;
  primary_health_agent_age_secondary_trustee: string;
  primary_health_agent_phone_number_secondary_trustee: string | undefined;
  primary_health_agent_relation_secondary_trustee: string;
  primary_trustee_health_agent_relation_secondary_trustee: string;
  secondary_trustee_health_agent_relation_primary_secondary_trustee: string;
  secondary_primary_health_agent_relation_primary_secondary_trustee: string;
  primary_health_agent_address_secondary_trustee: string;

  backup_health_agent_full_name_secondary_trustee: string;
  backup_health_agent_email_secondary_trustee: string;
  backup_health_agent_age_secondary_trustee: string;
  backup_health_agent_phone_number_secondary_trustee: string | undefined;
  backup_health_agent_relation_secondary_trustee: string;
  backup_trustee_health_agent_relation_secondary_trustee: string;
  secondary_trustee_health_agent_relation_backup_secondary_trustee: string;
  secondary_primary_health_agent_relation_backup_secondary_trustee: string;
  backup_health_agent_address_secondary_trustee: string;
  ...
  secondary_trustee_financial_agent_relation_primary: string;
  secondary_primary_financial_agent_relation_primary: string;
  ...
  secondary_trustee_financial_agent_relation_backup: string;
  secondary_primary_financial_agent_relation_backup: string;
  backup_financial_agent_address: string;

  primary_financial_agent_full_name_secondary_trustee: string;
  primary_financial_agent_email_secondary_trustee: string;
  primary_financial_agent_age_secondary_trustee: string;
  primary_financial_agent_phone_number_secondary_trustee: string | undefined;
  primary_financial_agent_relation_secondary_trustee: string;
  primary_trustee_financial_agent_relation_secondary_trustee: string;
  secondary_trustee_financial_agent_relation_primary_secondary_trustee: string;
  secondary_primary_financial_agent_relation_primary_secondary_trustee: string;
  primary_financial_agent_address_secondary_trustee: string;

  backup_financial_agent_full_name_secondary_trustee: string;
  backup_financial_agent_email_secondary_trustee: string;
  backup_financial_agent_age_secondary_trustee: string;
  backup_financial_agent_phone_number_secondary_trustee: string | undefined;
  backup_financial_agent_relation_secondary_trustee: string;
  backup_trustee_financial_agent_relation_secondary_trustee: string;
  secondary_trustee_financial_agent_relation_backup_secondary_trustee: string;
  secondary_primary_financial_agent_relation_backup_secondary_trustee: string;
  backup_financial_agent_address_secondary_trustee: string;
  ...
  health_care_secondary: string;
  perform_autopsy_secondary: number;
  organ_donation_secondary: number;
  ...
  burial_decisions_for_secondary: string;
  body_buried_cremated_secondary: string;
  funeral_service_secondary: string;
  post_death_arrangement_secondary: string;
  ...
  temp_secondary_trustee_guardian_relation_primary: string;
  temp_secondary_primary_guardian_relation_primary: string;
  ...
  temp_secondary_trustee_guardian_relation_backup: string;
  temp_secondary_primary_guardian_relation_backup: string;
  ...
  secondary_trustee_guardian_relation_primary: string;
  secondary_primary_guardian_relation_primary: string;
  ...
  secondary_trustee_guardian_relation_backup: string;
  secondary_primary_guardian_relation_backup: string;
