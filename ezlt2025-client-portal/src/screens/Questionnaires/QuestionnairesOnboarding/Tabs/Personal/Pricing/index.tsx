...
const Pricing: React.FC = () => {
  ...
  const planPrice =
    watch("marriage_status") === "SINGLE"
      ...
      : couple_price?.toFixed(2);
  const investmentProperty = watch("investment_properties_count");
  ...
  const handleApplyPromoCode = async () => {
    try {
      ...
      if (PromoCodeValid?.id) {
        ...
        setTotal(sub_total - discountAmount);
                      ...
                      render={({ field, fieldState: { error } }) => (
                        <Select
                          ...
                          onChange={(e) => {
                            ...
                            const subtotal =
                              watch("marriage_status") === "SINGLE"
                                ? single_price + parseInt(e.target.value) * 100
                                : Number(couple_price) +
                            ...
                            const discountAmount = parseInt(
                              `${
                                Number(subtotal) *
                                ((promotionCode?.data
                                  ?.discountInPercentage as number) /
                                  100)
                              }`,
                            );
                  ...
                  >
                    ...
                    >
                      ...
                      <Button
                        sx={{ ml: 1, height: "36px" }}
                        variant="contained"
                        onClick={(e) => handleApplyPromoCode()}
