...
const TrustName: React.FC = () => {
  ...
  useEffect(() => {
    setValue("trust_name_confirmed", !watch("trust_name_confirmed"));
  }, [watch("trust_status")]);
  return (
    <>
                ...
                render={({ field }) => (
                  <RadioGroup
                    ...
                    onChange={(e) => {
                      ...
                      setValue("trust_name_confirmed", true);
                    }}
                  >
                    <Box
                      sx={{
                ...
                render={({ field, fieldState: { error } }) => (
                  <>
                    ...
                    {watch("trust_name_confirmed") && (
                      ...
                      >
                        Uncheck the box to edit Trust name
                      </Typography>
                    )}
                  </>
                )}
