...
const PrimaryResidence = [
  {
    ...
    value: PrimaryResidenceEnum.SINGLE_FULLY_OWN,
  },
  {
    label: "We partially own this property with another person(s)",
    value: PrimaryResidenceEnum.SINGLE_PARTIALLY_OWN,
  },
  {
    label: "No, we rent this property",
    value: PrimaryResidenceEnum.SINGLE_RENT,
  },
];
const QuitCliams = [
  {
    label: "Yes. Please prepare the documents for our Primary Home",
    value: QuitClaimEnum.SINGLE_PREPARE_CLAIM,
  },
  {
    label: "No. We don’t need a Quit Claim filed at this time",
    value: QuitClaimEnum.SINGLE_DONT_PREPARE_CLAIM,
  },
  {
    label: "No. Our property is already under a Trust name",
    value: QuitClaimEnum.SINGLE_PROPERTY_ALREADY_PROTECTED,
  },
];
      ...
      <Grid container spacing={3}>
        <Grid xs={12} md={6} item>
          ...
          >
            ...
            {watch("quit_qlaim") === QuitClaimEnum.SINGLE_PREPARE_CLAIM && (
              <>
                <Box>
          ...
          <BoxWrapper>
            ...
            {watch("quit_qlaim") === QuitClaimEnum.SINGLE_PREPARE_CLAIM &&
              (watch("primary_residence") ===
                PrimaryResidenceEnum.SINGLE_FULLY_OWN ||
                watch("primary_residence") ===
                  PrimaryResidenceEnum.SINGLE_PARTIALLY_OWN) && (
                <Box>
                  <Button
                    variant="contained"
                    sx={{
