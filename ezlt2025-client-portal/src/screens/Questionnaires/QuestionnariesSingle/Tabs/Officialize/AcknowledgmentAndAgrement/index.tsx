...
const list = [
  "<strong>Voluntary Information Submission-</strong> I confirm that all information provided and entered on this website was submitted voluntarily and is accurate to the best of our knowledge.",
  "<strong>Non-Legal Service Acknowledgment -</strong> I acknowledge that EZ Living Trust and Strategic Choices Financial are not law firms. Their role is solely to assist in the preparation of legal documents. These documents have been prepared, updated, and reviewed by reputable third-party professionals. I/we understand that this assistance does not constitute legal advice or services.",
  "<strong>Document Effectiveness -</strong> I understand that the legal effectiveness of our documents is contingent upon obtaining all required signatures and notarizations. Specifically, for a revocable trust, I/we recognize that the trust must be properly funded for it to be legally enforceable. This acknowledgment emphasizes the importance of completing all necessary steps for document validity.",
  "<strong>Legal Challenges  -</strong> I acknowledge that while our legal documents have been reviewed by reputable legal professionals, no guarantee is made that the documents will be immune from legal challenges. Every legal situation is unique, and we recognize that it is possible for any estate to be subject to litigation, which could result in a court ruling that affects the distribution of assets. By signing this agreemI affirm that we have reviewed a sample of the documents provided and understand the importance of seeking personalized legal advice for specific concerns.",
  "<strong>Accuracy of Provided Information -</strong> I acknowledge that any Quit Claim deeds or related documents are based on the information we have provided. We understand that EZ Living Trust does not verify the accuracy of the information we submit and other property records are obtained from reputable third parties that may not updated records on time. I/we will verify the accuracy of all documents prepared before execution.",
  "<strong>Document Retention Responsibility -</strong> I recognize that EZ Living Trust is not responsible for maintaining permanent records of our documents. I/we intend to secure copies of our documents for future reference and accessibility.",
];
        ...
        <Box>
          ...
          <CustomModal width={{ xs: "100%", sm: "auto" }} open={open} handleClose={handleClose}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column" }}>
              <Box sx={{ border: "1px solid #dedede", borderRadius: "5px", textAlign: 'center' }}>
                <SignatureCanvas
                  ref={(ref) => {
                    sigPad = ref;
                  }}
