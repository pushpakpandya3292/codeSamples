          ...
          <Grid container spacing={5}>
            ...
            <Box>
              ...
              >
                <Typography
                  sx={{
                    width: watch("investment_properties_count")
                      ? "22.8%"
                      : "20%",
                  }}
                  variant="h4"
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  ...
                  You can personally file your quit claim, or we will recommend
                  an expert title service that can file it for a nominal filing
                  and tracking fee.
                </Typography>
              </Box>
            </Grid>
