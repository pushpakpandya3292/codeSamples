...
import { CitizenShipEnum } from "@/screens/Questionnaires/QuestionnairesCouple/constants";
import { EmploymentStatusEnum } from "../../../constants";
...
const PrimaryTrustee: React.FC = () => {
  ...
  useEffect(() => {
    setValue("primary_trustee_county", watch("primary_trustee_address")?.administrativeAreaLevelTwo)
      ...
      <Grid container columnSpacing={2}>
        <Grid xs={12} md={6} item>
          ...
          >
            ...
            >
              <Typography variant="h3">Legal Name (Primary Trustee)</Typography>
              {fieldsDisabled ? (
                <Box
                  sx={{
                    height: "26px",
            ...
            <Grid container rowSpacing={3} columnSpacing={1}>
              ...
              <Grid xs={12} md={6} item>
                <Controller
                  ...
                  control={control}
                  defaultValue={watch("primary_trustee_address")?.administrativeAreaLevelTwo}
                  render={({ field, fieldState: { error } }) => (
                    <CustomTextField
                      {...field}
                      {...renderFieldProps(error)}
              ...
              <Grid xs={12} md={6} item>
                <Controller
                  name={"primary_trustee_empolyment_status"}
                  control={control}
                  render={({ field, fieldState: { error } }) => (
                    <CustomTextField
                      {...field}
              ...
              <Grid xs={12} md={6} item>
                <Controller
                  name={"primary_trustee_estimated_annual_income"}
                  control={control}
                  render={({ field, fieldState: { error } }) => (
                    <CustomTextField
                      value={field.value}
