...
import { StyledTypography, stepsMainHeadingStyle, subHeadingStyle } from "..";
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                ...
                >
                  ...
                  {!(
                    watch("primary_residence") ==
                    PrimaryResidenceEnum.SINGLE_RENT
                  ) && (
                    <Box>
                      <Typography variant="h5">
                      ...
                      <Typography>
                        {watch("quit_qlaim") ==
                          QuitClaimEnum.SINGLE_PREPARE_CLAIM &&
                          "Yes, please prepare the Quit Claim for this property (included)"}
                        {watch("quit_qlaim") ==
                          QuitClaimEnum.SINGLE_DONT_PREPARE_CLAIM &&
                          "No, I don’t want to protect this property at this time."}
                        {watch("quit_qlaim") ==
                          QuitClaimEnum.SINGLE_PROPERTY_ALREADY_PROTECTED &&
